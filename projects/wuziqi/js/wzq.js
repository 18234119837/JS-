...
function drawChess(x, y, color) {
    ...
    // if(color=="black"){
    //     var img = new Image();
    //     img.src = 'img/baiqi-pc.png';
    //     var pattern = cobj.createPattern(img, "no-repeat");
    // }else{
    //     var img = new Image();
    //     img.src = 'img/heiqi-pc.png';
    //     var pattern = cobj.createPattern(img, "no-repeat");
    // }
    // cobj.fillStyle =ypattern;
...
//         this.cobj.fill();
//         this.cobj.restore();
//         this.pos[this._myj(x,y)]=color;
//         delete this.blank[this.j(x,y)];
//     }
//     _myj(x,y){
//         return x + "_" + y;
//     }
