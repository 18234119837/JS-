    ...
    $.each(data, function (index, val) {
        if (state == 'wait') {//如果是未完成的
            if (val.isDone == 0) {
                ...
                str += "<li id='" + index + "'  style='color:#000;background: #fff9b2'><input type='checkbox'><time>" + getYear(val.time) + "<br><span>" + gettime(val.time) + "</span></time> <p style='color:#000'>" + val.con + "</p> <span   class='iconfont "+className+" '>&#xe662;</span><div class='right'>完成</div></li>";
            }
        }
